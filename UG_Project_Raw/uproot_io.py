...
class Events:
    def __init__(self, filename):
        ...
        self.reco_particle_tier = tree['pfoTier'].array(library="np")
        ...
        self.mc_tier = tree['bestMCParticleTier'].array(library="np")
        self.mc_energy = tree['bestMCParticleEnergy'].array(library="np")
        self.mc_px = tree['bestMCParticleMomentumX'].array(library="np")
        self.mc_py = tree['bestMCParticleMomentumY'].array(library="np")
        self.mc_pz = tree['bestMCParticleMomentumZ'].array(library="np")
        self.mc_num_true_tracks_U = tree['nTrueTracksU'].array(library="np")
        self.mc_num_true_tracks_V = tree['nTrueTracksV'].array(library="np")
        self.mc_num_true_tracks_W = tree['nTrueTracksW'].array(library="np")
        self.mc_num_true_showers_U = tree['nTrueShowersU'].array(library="np")
        self.mc_num_true_showers_V = tree['nTrueShowersV'].array(library="np")
        self.mc_num_true_showers_W = tree['nTrueShowersW'].array(library="np")
        # metrics
        self.purity = tree['purity'].array(library="np")
        self.completeness = tree['completeness'].array(library="np")
        self.is_true_track = tree['isTrueTrack'].array(library="np")
        self.is_reco_track = tree['isPandoraTrack'].array(library="np")
        # neutrino
